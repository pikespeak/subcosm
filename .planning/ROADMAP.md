...
- [ ] 05-03-PLAN.md — Onboarding: static splash hook+teaser+CTA (D-09) + first-run coachmark (D-02) (SUB-04)

**Wave 3** *(blocked on 05-03)*

- [ ] 05-04-PLAN.md — Mobile perf tuning (D-05) + bespoke Techno aesthetic (D-07) (SUB-03, SUB-05)
