...
- [ ] **Phase 4: Live Game** - Live frontier fills during the day, freezes overnight irreversibly, the tick scores the day against its goal (GAME-02/03/04), and a pinned reveal post shows what the community's universe became — the full retention loop (CODE-COMPLETE 2026-06-22: all 6 criteria code-verified incl. GAME-03 closed by gap-plan 04-05; criteria 4-6 await on-device devvit playtest UAT before the phase is marked complete)
